...
public interface NoteBookMapper {
    ...
    @Results({
            ...
            @Result(property = "noteList",column = "id",many = @Many(select = "com.cloudnote.notebook.dao.mapper.NoteMapper.selectByNoteBookId"))
        })
    ...
    @Results({
            ...
            @Result(property = "noteList",column = "id",
                    many = @Many(select = "com.cloudnote.notebook.dao.mapper.NoteMapper.selectByNoteBookIdWithTags"))
    })
