...
public interface NoteMapper {
    ...
    @Results({
            ...
            @Result(property = "noteBook", column = "note_book_id",
                    one = @One(select = "com.cloudnote.eureka.client." +
    ...
    @Results({
            @Result(property = "id",column = "id"),
            @Result(property = "noteBookId",column = "note_book_id"),
            @Result(property = "noteBook",column = "note_book_id",one = @One(select = "com.cloudnote.eureka.client.web.dao.mapper.NoteBookMapper.get"))
    })
